...
public class VMConstants {
    ...
    public final static String DINSTALL_DOCKER_COMMAND = "sudo snap install docker";
...
/******** Get Docker containers based on image name processes  *******************/
	...
	public final static String DOCKER_LIST_CONTAINER=" sudo docker container ls -q";
	
	/***** List of docker containers with image name *****/
	public final static String DOCKER_LIST_WITH_NAME_CONTAINER="sudo docker container ls -f ancestor=%s -q";
	...
	public final static String CONTAINER_STATS=" sudo docker stats %s --no-stream";
	
	/***************Docker Container stop******************/
	public final static String DOCKER_CONTAINER_STOP="sudo docker container stop %s";
	
	/************** Docker Command to run docker in detacted mode*********/
	public final static String DOCKER_CONTAINER_START="sudo docker container run -d %s";
    /******************************Exception Messages*************************************/
